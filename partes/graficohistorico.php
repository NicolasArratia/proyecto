                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Grafico de registros historicos de gastos comunes</h1>
                                <p class="lead text-muted">todos los gatos comunes de la historia de edifred</p>
                            </div>
